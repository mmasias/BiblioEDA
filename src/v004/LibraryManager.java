...
public class LibraryManager {
    ...
    private void findBooksAuthor() {
        System.out.println("Introduce el nombre del autor:");
        String authorName = scanner.nextLine();
        int authorId = findAuthorIdByName(authorName);
        if (authorId != -1) {
            showBooksOfAuthorRecursively(authorId, 0);
        } else {
    ...
    public void showBooksOfAuthorRecursively(int authorId, int bookIndex) {
